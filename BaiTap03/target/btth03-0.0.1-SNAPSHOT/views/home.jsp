...
<head>
<meta charset="UTF-8">
<title>Trang chủ - Shopping MVC Store</title>
...
<body>
    ...
    <div class="hero-banner">
        <div class="container">
            <h1 style="font-weight: bold; margin-bottom: 10px;">Chào Mừng Đến Với Shopping Store</h1>
            ...
            <a href="<c:url value='/product'/>" class="btn btn-warning btn-lg" style="margin-top: 15px; font-weight: bold;">
                <i class="fa fa-shopping-bag"></i> Khám phá ngay (Phân trang 6sp/trang)
            </a>
        </div>
    </div>
    ...
    <div class="container">
        ...
        <div class="well text-center" style="margin: 40px 0; background-color: #eef6fc; border-color: #bce8f1;">
            ...
            <p class="text-muted">Trang sản phẩm đầy đủ với tính năng phân trang 6 sản phẩm mỗi trang và lọc theo từng danh mục.</p>
            <a href="<c:url value='/product'/>" class="btn btn-primary">
                <i class="fa fa-th-large"></i> Đến trang /product (6 sản phẩm/trang)
            </a>
        </div>
    </div>
</body>
